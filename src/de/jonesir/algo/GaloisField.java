...
/**
 * Implementation of Galois field arithmetics with 2^p elements. The input must be unsigned integers.
 */
public class GaloisField {
	...
	public static void main(String[] args){
		GaloisField gf = GaloisField.getInstance(16, 19);
		int a1 = 13, b1 =7, c1 = 3;
		System.out.println(gf.add(gf.multiply(a1,b1), c1));
	 ...
	 * @param y
	 *            right-hand side of the Vandermonde system equation. will be replaced the output in this vector
	 */
	 ...
	 * 
	 * @param dividend
	 *            dividend polynomial, the remainder will be placed here when return
	 * @param divisor
	 *            divisor polynomial
	 */
